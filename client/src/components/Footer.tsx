      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm">
              Llevamos a tu evento la tradición más entrañable de la cocina
              española con pasión, sabor y mucha experiencia.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#inicio" className="hover:text-[#f8b400]">
                  Inicio
                </a>
              </li>
              <li>
                <a href="#ofrecemos" className="hover:text-[#f8b400]">
                  ¿Qué ofrecemos?
                </a>
              </li>
              <li>
                <a href="#paellas" className="hover:text-[#f8b400]">
                  Nuestras paellas
                </a>
              </li>
              <li>
                <a href="#delicias" className="hover:text-[#f8b400]">
                  Delicias de España
                </a>
              </li>
              <li>
                <a href="#contacto" className="hover:text-[#f8b400]">
                  Contacto
                </a>
              </li>
              <li>
                <a href="#calendario" className="hover:text-[#f8b400]">
          ...
          <div>
            ...
            <a
              href="https://forms.gle/WhnRSJvgyVFTtzva7"
              target="_blank"
        ...
        <div className="border-t border-[#f2e8dc]/30 mt-12 pt-6 text-center text-xs">
          &copy; {new Date().getFullYear()} Paellas y Olé. Todos los derechos
          reservados.
        </div>
      </div>
    </footer>
